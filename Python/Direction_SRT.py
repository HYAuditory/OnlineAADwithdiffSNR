...
def Direction(tr, original, opposite, screen, port):
    ...
    if ( tr >= 1 and tr <= 7 ) or (tr >= 15 and tr <= 18) or (tr >= 27 and tr <= 30) or (tr >= 34 and tr <= 39) :      # Represent Origin direction
    ...
    elif ( tr >= 8 and tr <= 14 ) or (tr >= 19 and tr <= 26) or (tr >= 31 and tr <= 33) or (tr >= 40 and tr <= 42) :      # Represent Opposite direction
